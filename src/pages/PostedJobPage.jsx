...
//   const { id } = useParams(); // this will be compared with postedBy
...
//   //       // ✅ filter based on postedBy from the URL
...
//   //       if (!id){
//   //         setSelectedJob((prev) => prev ?? filteredJobs[0])
//   //       }
//   //     } catch (err) {
//   //       console.error('Error fetching jobs in PostedJobPage:', err);
//   //     }
//   //   };
...
//           if (id) {
//             // ✅ select only if job with id exists
//             const foundJob = filteredJobs.find(
//               (job) => String(job.id) === String(id)
//             );
//             setSelectedJob(foundJob || null); // null if not found
//           } else {
//             // ✅ no id → pick first one
...
//   return (
//     <div className="bg-mine-shaft-950 min-h-[100vh] font-poppins flex p-5 overflow-x-hidden">
//       <div>
//         <IconMenu2
//           className="text-mine-shaft-300 hidden bs-mx:block"
//           onClick={toggleMenu}
//         />
//       </div>
// {/* 
//       <div
//         className={`absolute top-20 left-10 h-[80vh] w-[20vw] bg-mine-shaft-900 p-4 rounded-md z-50 transition-transform duration-300 ease-in-out bs-mx:block lg:hidden
