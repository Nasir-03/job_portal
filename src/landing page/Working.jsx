...
const Working = () => {
  return (
    <div>
      ...
      {/* <div className="flex relative text-white md-mx:flex-col mt-20 xs-mx:mt-10 gap-10 items-center justify-center">
        <div className="w-[50%] bs-mx:w-[45%] md-mx:w-full xs-mx:mt-0">
          <img
            src={girls}
            alt="girls images"
            className="h-[50vh] xs-mx:h-[30vh] xs-mx:w-[30wh] object-contain w-full rounded-lg"
          />
        </div>

        <div className="absolute left-[35%] bs-mx:left-[25%] top-10 bs-mx:top-16 w-40 bs-mx:w-32 md-mx:left-[55%] border border-yellow-500 rounded-xl h-auto text-center px-2 py-2 backdrop-blur-md">
          <div className="h-20 w-20 bg-blue-500 rounded-full overflow-hidden flex items-center justify-center border-2 mx-auto">
            <img
              src={avatar}
              alt="avatar"
            ...
            <div className="lg-mx:text-sm">
          <h1 className="text-lg lg-mx:text-base">Complete your profile</h1>
          <p className="text-sm lg-mx:text-sm">70% completed</p>
          </div>
        </div> */}
  ...
  <div className="relative w-[50%] bs-mx:w-[45%] md-mx:w-full xs-mx:mt-0 flex justify-center">
    ...
    >
      ...
      <div className="mt-2">
        <h1 className="text-sm sm:text-base md:text-lg">Complete your profile</h1>
...
{/* </div> */}
      ...
      <div className="">
        <div className="flex">
            <div className="bg-bright-sun-300 border-2 rounded-full h-20 w-20"></div>
            <div>
